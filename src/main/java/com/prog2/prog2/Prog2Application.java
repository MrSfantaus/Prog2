...
public class Prog2Application {
	...
	/*
	 ...
	 - Giorno 3
		...
		- GET di tutti i todo di 1 utente -> /users/{userid}/todos GET										[ NI ]
		- Creazione di un todo per uno specifico utente -> /users/{userid}/todos POST 						[ NI ]
		- Eliminazione di uno specifico todo di un utente -> /users/{userid}/todos/{todoid} DELETE			[ NI ]
		!!!!  ( FUNZIONANO IN TODOController, quindi, con indirizzo alternativo )
		- Se il TODO ha titolo e descrizione visualizza tutto												[ Da Fare ]
		- Visualizzare tutti i TODO di un utente (solo lista)												[ Visualizza elenco completo..]
		- Se seleziono un TODO ne vedo il contenuto															[ Da Fare ]
		- Verifica il collegamento tra TODO e Users															[ Da Fare ]
	 */
}
